...
export default async function JournalPage({ searchParams }: { searchParams: Promise<{ taster?: string; verdict?: string; style?: string }> }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-8">
    <header><p className="text-sm text-[var(--text-dim)]">somm@cellar:~$ journal --household</p><h1 className="bloom-cyan mt-2 flex items-center gap-3 text-2xl text-[var(--cyan)]"><Journal /> ── TASTING JOURNAL ──</h1></header>
